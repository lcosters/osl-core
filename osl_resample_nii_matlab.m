...
%     [output_x,output_y,output_z,output_mask_vol,output_xform,output_step] = load_nii_vol(output_mask,false);
    [input_x,input_y,input_z,input_vol,input_xform,input_step] = nii.load(input_nii);
    [output_x,output_y,output_z,output_mask_vol,output_xform,output_step] = nii.load(output_mask);
