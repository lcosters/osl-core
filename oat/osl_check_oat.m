...
try oat.source_recon.method=oatin.source_recon.method; oatin.source_recon = rmfield(oatin.source_recon,'method'); oat.source_recon = ft_checkopt(oat.source_recon,'method','char',{'none','beamform','beamform_bilateral','mne_eye','mne_diag_datacov', 'mne_adaptive'}); catch,  oat.source_recon.method='beamform'; warning(['oat.source_recon.method either not specified or incorrectly specified, Setting it to: ' oat.source_recon.method]); end; % can be 'beamform' or 'none' or 'beamform_bilateral' (for a sensor space analysis)
